    ...
    <body>
        <div id="main-container">
            ...
            <div class="section" id="features">
                ...
                <div class="container-cookies d-flex align-items-center">
                    <div class="container d-flex align-items-start align-items-md-center  flex-md-row flex-column">
                        <p class="m-0 container-cookies__description mr-md-5 py-2">En este portal utilizamos <b class="">“cookies”</b> propias y de terceros para gestionar el portal, elaborar información estadística, optimizar la funcionalidad del sitio y mostrar publicidad relacionada con sus preferencias a través del análisis de la navegación.</a></p> 
                        <button class="button container-cookies__button my-2">Acepto</button>
                    </div>
                </div>
            </div>
    
            <footer>
                SB & William Tory's project© Derechos Reservados
            </footer>
        </div>
    </body>
    </html>